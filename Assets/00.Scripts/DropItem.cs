...
public class DropItem : MonoBehaviour , IPoolable<DropItem> , IDisposable
{
    ...
    private void Update()
    {
        ...
        var destinationXZ = new Vector3(destination.position.x, 0, destination.position.z);
        var itemXZ = new Vector3(itemTransform.position.x, 0, itemTransform.position.z);
